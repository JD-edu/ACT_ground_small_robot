...
// ===========================
const char* ssid = "codinglab2G(2)";
const char* password = "codinglab";
...
void setup() {
    ...
    */
    while(!client.connect(websockets_server_host, websockets_server_port, "/pang/ws/pub?channel=c3rl43o6n88jq9lrl3og&track=video")) { 
        delay(500);
        Serial.print(".");
        //oled.clear();
